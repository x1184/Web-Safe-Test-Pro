...
$(document).ready(function()
{
   ...
   $("#PanelMenu1").panel({animate: true, animationDuration: 200, animationEasing: 'easeOutQuad', dismissible: true, display: 'overlay', position: 'right', toggle: true, overlay: true});
});